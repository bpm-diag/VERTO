...
export default class VERTOActivityModel {
...
function getAttr (obj, key) {
  ...
  else throw new StrError(`[VERTOActivityModel] Input obj has not key '${key}'`, obj)
}
...
function parseFromString (str) {
  ...
  try {
    ...
    console.error(exc)
    throw new StrError('[VERTOActivityModel] Cannot parser Input str as a json. Invalid format.')
  }
}
