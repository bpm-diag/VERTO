...
const constraintTypes = {
  ...
  */
  ...
  Relation: {
    ...
    AlternateResponse: new AlternateResponse(),
    AlternatePrecedence: new AlternatePrecedence(),
    ChainResponse: new ChainResponse(),
    ChainPrecedence: new ChainPrecedence(),
    RespondedExistence: new RespondedExistence()
  },
  'Mutual Relation': {
    CoExistence: new CoExistence(),
    Succession: new Succession(),
    ChainSuccession: new ChainSuccession(),
    AlternateSuccession: new AlternateSuccession()
  },
  'Negative Relation': {
    NotCoExistence: new NotCoExistence(),
    NotSuccession: new NotSuccession(),
    NotChainSuccession: new NotChainSuccession()
  }
}
